...
// This is brl/bseg/boxm2/ocl/pro/processes/boxm2_ocl_render_depth_entropy_process.cxx
#include <bprb/bprb_func_process.h>
//:
// \file
// \brief  A process for rendering scene entropy.
//
...
namespace boxm2_ocl_render_depth_entropy_process_globals
{
  ...
  void compile_kernel(bocl_device_sptr device,vcl_vector<bocl_kernel*> & vec_kernels, vcl_string opts)
  {
    ...
    src_paths.push_back(source_dir + "bit/cast_ray_bit.cl");
	  ...
	  options += " -D RENDER_ENTROPY -D RENDER ";
...
bool boxm2_ocl_render_depth_entropy_process_cons(bprb_func_process& pro)
{
  using namespace boxm2_ocl_render_depth_entropy_process_globals;
...
bool boxm2_ocl_render_depth_entropy_process(bprb_func_process& pro)
{
  using namespace boxm2_ocl_render_depth_entropy_process_globals;
